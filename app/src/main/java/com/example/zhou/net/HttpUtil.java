...
import com.example.zhou.base.Constants;
import com.example.zhou.util.SystemUtil;
...
//rxjava+retrofit（封装了一个更强大的okhttp）
public class HttpUtil {
    ...
    private OkHttpClient getOkHttpClient() {
        ...
        OkHttpClient.Builder builder = new OkHttpClient.Builder()
                .cache(cache)//缓存
                .addInterceptor(new MyCacheinterceptor())//缓存拦截器
                .addNetworkInterceptor(new MyCacheinterceptor())//缓存拦截器
                //设置写入时间
